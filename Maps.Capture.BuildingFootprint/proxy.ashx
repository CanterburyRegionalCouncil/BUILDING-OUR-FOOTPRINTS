...
using System.Configuration;
    ...
    public class proxy : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            cred.Password = Maps.Capture.BuildingFootprint.Properties.Settings.Default.ImpersonatePwd;
            cred.UserName = Maps.Capture.BuildingFootprint.Properties.Settings.Default.ImpersonateUser;
            cred.Domain = Maps.Capture.BuildingFootprint.Properties.Settings.Default.ImpersonateDomain;
